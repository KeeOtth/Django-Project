...
class Contas(models.Model):
    ...
    tp_conta = models.CharField(choices=TIPO_CONTA, max_length=30, default="Poupança")
    id_banco = models.IntegerField()
    banco = models.CharField(choices=TIPO_BANCO, max_length=30, default="Banco1")
...
class Pessoas(models.Model):
    ...
    vinculo_pessoa = models.CharField(choices=VINCULO_CHOICES, max_length=30, default='Vinculo1')
